export const universalErc20Abi = [
    ...
    items: [
      {
        ...
        inputs: [
          { name: 'locking_contract', type: 'core::starknet::contract_address::ContractAddress' },
        ],
        outputs: [],
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'eic_data', type: 'core::option::Option::<src::replaceability_interface::EICData>' },
  ...
  { type: 'impl', name: 'RolesImpl', interface_name: 'src::roles_interface::IMinimalRoles' },
  {
    type: 'interface',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'recipient', type: 'core::starknet::contract_address::ContractAddress' },
      { name: 'permitted_minter', type: 'core::starknet::contract_address::ContractAddress' },
      {
  ...
  },
  {
    ...
    kind: 'struct',
    members: [{ name: 'impl_hash', type: 'core::starknet::class_hash::ClassHash', kind: 'data' }],
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'added_by', type: 'core::starknet::contract_address::ContractAddress', kind: 'data' },
    ],
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    variants: [
      ...
      { name: 'RoleGranted', type: 'src::access_control_interface::RoleGranted', kind: 'nested' },
      { name: 'RoleRevoked', type: 'src::access_control_interface::RoleRevoked', kind: 'nested' },
      {
